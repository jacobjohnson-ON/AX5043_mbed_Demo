...
// Receive buffer
extern uint8_t ax5043_rxbuffer[PKTDATA_BUFLEN];

// Receiver globals
extern uint8_t ax5043_pktlen;
extern int16_t ax5043_rssi;
extern int32_t ax5043_offset;
extern int16_t ax5043_offset_hz;
...
uint8_t ax5043_get_rx_pktlen();
int16_t ax5043_get_rssi();
int32_t ax5043_get_freq_offset_hz();
...
void ax5043_readfifo(const uint8_t *ptr, uint8_t len);
